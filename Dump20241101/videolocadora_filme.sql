...
--
-- Host: 127.0.0.1    Database: videolocadora
-- ------------------------------------------------------
...
INSERT INTO `filme` VALUES (1,'300',1,'Richard Donner',3.5,'n'),(2,'Máquina Mortífera',1,'Richard Donner',3.6,'n'),(3,'A Mexicana',2,'Burr Steers',2,'s'),(4,'A Verdade Nua e Crua',2,'Robert Luketic',4,'n'),(5,'A vida é bela',2,'Roberto Benigni',3.5,'s'),(6,'Austrália',3,'Baz Luhrmann',4,'s'),(7,'Ultimato Bourn',3,'Paul Greengrass',3.5,'n'),(8,'Constantine',4,'Francis Lawrence',2.5,'s'),(9,'Os Irmãos Grimm',4,'Terry Gilliam',3.5,'n'),(10,'Os Doze Macacos',4,'Terry Gilliam',2.5,'n'),(11,'Amadeus',5,'Milos Forman',10,'n'),(12,'As Torres Gêmeas',5,'Oliver Stone',2.5,'s'),(13,'Platoon',1,'Oliver Stone',5.5,'s'),(14,'O Advogado do Diabo',6,'Taylor Hackford',1.5,'s'),(15,'Beowulf',7,'Robert Zemeckis',1,'n'),(16,'Bolt o super cão',7,'Byron Howard',1.5,'s'),(17,'Apertem o cinto o piloto sumiu',9,'Jim Abrahams',3.6,'s'),(18,'Doze é demais',9,'Shawn Levy',9.2,'s'),(19,'Uma noite no museu',9,'Shawn Levy',2.5,'n');
